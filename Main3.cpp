...
#include <numeric>
#include <cstdlib>
#include <unistd.h>  // For UNIX-like systems (MacOS)

using namespace std;

const int MAX_SIZE = 1000;

// Function to set color using ANSI escape codes
void SET_COLOR(const string& color) {
    if (color == "RED") cout << "\033[1;31m";
    else if (color == "GREEN") cout << "\033[1;32m";
    else if (color == "YELLOW") cout << "\033[1;33m";
    else if (color == "BLUE") cout << "\033[1;34m";
    else if (color == "MAGENTA") cout << "\033[1;35m";
    else if (color == "CYAN") cout << "\033[1;36m";
    else if (color == "WHITE") cout << "\033[1;37m";
