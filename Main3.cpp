...
public:
    ...
    static void writeFile(const string& filename, const NhanVien employees[], int size) {
...
void xuatds(const NhanVien nv[], int size) {
...
void TKMaNV(const NhanVien nv[], int size) {
    long long Ma;
    int count = 0;
...
void TKCCCD(const NhanVien nv[], int size) {
    long long cccd;
    int count = 0;
...
void TKTen(const NhanVien nv[], int size) {
    string ten;
    int count = 0;
...
void tongLuong(const NhanVien nv[], int size) {
...
void thucLinhmax(const NhanVien nv[], int size) {
    if (size == 0) {
...
void timphucap(const NhanVien nv[], int size) {
    int count = 0;
    for (int i = 0; i < size; ++i) {
